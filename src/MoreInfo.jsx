    ...
    return (
        <div className='p-10 grid grid-cols-1 '>
            ...
            <div className='flex justify-between items-center space-x-10'>
                <div className='bg-amber-400/50 p-7 max-w-2xl h-120'>
                    <div className='mb-5 flex justify-between'>
                        <h1 className='uppercase text-2xl'>Vision & Strategy</h1>
                        <House className='w-10 h-10' />
                    </div>
                    <div className='border-t-2 mb-50'></div>
            ...
            <button className='text-white text-2xl bg-pink-400 p-5 mx-auto rounded-lg mt-7'>Get Free Apointment</button>
        </div>
    )
}
