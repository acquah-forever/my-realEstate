    ...
    return (
        <div id='listings' className='px-6 py-12 sm:px-10 md:px-16 lg:px-24 flex justify-center md:justify-start'>
            <div className=' bg-amber-200/70 text-slate-600 200 w-full max-w-2xl p-6 sm:p-8 md:p-10 '>
                ...
                <div className='flex flex-wrap text-base sm:text-lg md:text-xl items-center'>
                    <div className='flex flex-wrap text-base sm:text-lg md:text-xl items-center'>
                        <h1>3 Bed</h1>
                        <h1>2 Bath</h1>
                        <h1>200Sqm</h1>
                    ...
                    <div>
                        <button className='bg-linear-to-br from-green-400 to-green-600 px-8 py-2 rounded-lg'>
                            View
                        </button>
                    </div>
                </div>
