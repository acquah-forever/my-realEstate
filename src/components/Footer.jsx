                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                        ...
                        <nav className="flex flex-col">
                            ...
                            <div className="grid grid-flow-col gap-4">
                                <a className="hover:scale-110 transition-transform duration-300 hover:text-amber-400 cursor-pointer">
                                    <svg
                    ...
                    <div className="border-t border-slate-700 mt-8 pt-6 text-center">
                        <p className="text-sm sm:text-base text-slate-400">
                            ...
                            <a className="hover:text-amber-400 transition-colors duration-300 ml-2 cursor-pointer">Privacy Policy</a> |
                            <a className="hover:text-amber-400 transition-colors duration-300 ml-2 cursor-pointer">Terms of Service</a>
                        </p>
                    </div>
                </div>
            </footer>
