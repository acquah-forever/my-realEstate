            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:w-2/3'>
                ...
                <div className='relative'>
                    ...
                    <div className='absolute top-5 left-5 right-5 bg-amber-300/60 p-4 rounded-md'>
                        ...
                        <h2 className='mb-3 text-lg sm:text-xl'>A pre-war renovated property in an exclusive neighborhood.</h2>
                ...
                <div className='relative'>
                    ...
                    <div className='absolute top-5 left-5 right-5 bg-amber-300/60 p-4 rounded-md'>
                        ...
                        <h2 className='mb-3 text-lg sm:text-xl'>Luxurious living with breathtaking cityscapes from every room</h2>
                        <div className='border-t-2 mb-3'></div>
                        <div className='flex flex-wrap gap-3 text-sm'>
                            <h1>3 Bed</h1>
                            <h1>2.5 Bath</h1>
                ...
                <div className='relative'>
                    ...
                    <div className='absolute top-5 left-5 right-5 bg-amber-300/60 p-4 rounded-md'>
                        ...
                        <h2 className='mb-3 text-lg sm:text-xl'>Elegant design and urban serenity with a private outdoor space.</h2>
                        <div className='border-t-2 mb-3'></div>
                        <div className='flex flex-wrap gap-3 text-sm'>
                            <h1>3 Bed</h1>
                            <h1>3 Bath</h1>
