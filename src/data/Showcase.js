const showcase = [
...

    {
        ...
        price: "£420,000",
        location: "Bristol",
        description: "A state-of-the-art build filled with a serene and luscious envronment",
        bedrooms: 3,
        bathrooms: 2,
        area: "2880",
...

    {
        ...
        price: "£250,000",
        location: "Cardiff",
        description: "Cozy apartment fitted with latest furnishings and Severn Bach View",
        bedrooms: 3,
        bathrooms: 3,
        area: "1370",
        features: ["Foyer", "Garage", "Central Heating"],
        images: "https://images.unsplash.com/photo-1711426793021-ae58d127d79c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        listedDate: "2026-03-07",
        agent: {
            name: "Jack Reacher",
            phone: "+44 7700 900001",
